...
import com.my.remotemediator.database.NewsDatabaseModule_ProvideDatabaseFactory;
import com.my.remotemediator.network.NetworkModule_ProvideNewsApiServiceFactory;
import com.my.remotemediator.network.NetworkModule_ProvideRetrofitFactory;
import com.my.remotemediator.repository.NewsRepository;
import com.my.remotemediator.repository.NewsRepositoryImpl;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, javax.inject.Provider<ViewModel>>singletonMap("com.my.remotemediator.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.my.remotemediator.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.bindRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private Provider<NewsRepository> bindRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<NewsDatabase>(singletonCImpl, 3));
      this.newsRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 0);
      this.bindRepositoryProvider = DoubleCheck.provider((Provider) newsRepositoryImplProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.my.remotemediator.repository.NewsRepositoryImpl 
          return (T) new NewsRepositoryImpl(singletonCImpl.provideNewsApiServiceProvider.get(), singletonCImpl.provideDatabaseProvider.get());

          case 1: // com.my.remotemediator.service.NewsApiService 
          ...
          case 3: // com.my.remotemediator.database.NewsDatabase 
          return (T) NewsDatabaseModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
